...
class SimpleConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28), 
        ...
        self.params['W1'] = weight_init_std * \
                            np.random.randn(32, input_dim[0], 3, 3)
        ...
        self.params['W5'] = weight_init_std * \
                            np.random.randn(64, input_dim[0], filter_size, filter_size)
        self.params['b5'] = np.zeros(64)
        self.params['W6'] = weight_init_std * \
                            np.random.randn(64, input_dim[0], filter_size, filter_size)
        self.params['b6'] = np.zeros(64)
        ...
        self.layers['Pool1'] = Pooling(pool_h=2, pool_w=2, stride=1)
        self.layers['Conv3'] = Convolution(self.params['W5'], self.params['b5'],
                                           conv_param['stride'], conv_param['pad'])
        self.layers['Relu3'] = Relu()
        self.layers['Conv4'] = Convolution(self.params['W6'], self.params['b6'],
                                           conv_param['stride'], conv_param['pad'])
        self.layers['Relu4'] = Relu()
        self.layers['Pool2'] = Pooling(pool_h=2, pool_w=2, stride=1)
    ...
    def gradient(self, x, t):
        ...
        grads['W6'], grads['b6'] = self.layers['Conv4'].dW, self.layers['Conv4'].db
    ...
    def load_params(self, file_name="params.pkl"):
        ...
        for i, key in enumerate(['Conv1', 'Affine1', 'Affine2', 'Conv2', 'Conv3', 'Conv4']):
